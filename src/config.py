...
RATE_LIMIT_EMAIL_MEMBER_TIMES = int(os.environ.get("RATE_LIMIT_EMAIL_TIMES_SHORT", "5"))
RATE_LIMIT_EMAIL_MEMBER_SECONDS = int(os.environ.get("RATE_LIMIT_EMAIL_SECONDS_SHORT", "1800"))
# per-user
RATE_LIMIT_EMAIL_USER_TIMES = int(os.environ.get("RATE_LIMIT_EMAIL_TIMES_LONG", "20"))
RATE_LIMIT_EMAIL_USER_SECONDS = int(os.environ.get("RATE_LIMIT_EMAIL_SECONDS_LONG", "86400"))
